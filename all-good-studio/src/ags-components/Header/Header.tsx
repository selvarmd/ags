  ...
  return (
    <AppBar
      ...
      className={`${Styles.header} ${scrolled && Styles.scrolled} ${
        headerTheme === "dark" ? Styles.darkHeader : Styles.lightHeader
      }`}
    >
      <AgsContainer>
          ...
          <Box className={Styles.logo}>
            <Link to="/">
              ...
              >
                ...
                />
                <path
                  d="M84.7707 39.4612V40.246H83.1152V45.3262H82.0951V40.246H80.4307V39.4612H84.7707Z"
                  fill="currentColor"
                />
                <path
                ...
                />
                <path
                  d="M104.447 39.4612V45.3262H103.427V39.4612H104.447Z"
                  fill="currentColor"
                />
                <path
