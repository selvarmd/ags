...
const comparisonData = [
  ...
  {
    label: "Access",
    us: "Talk directly to the lead designer",
    agency: "Account layers",
  },
  { label: "Visibility", us: "Daily updates", agency: "Weekly status" },
  {
    label: "Pricing",
    us: "Fixed scopes • Clear pricing",
      ...
      <AgsContainer>
        ...
        <Box className={Styles.comparisonBlock}>
          <Box className={Styles.comparisonTable}>
            <Box
              className={`${Styles.comparisonRow} ${Styles.comparisonHeader}`}
            >
            ...
            {comparisonData.map((row, index) => (
              <Box key={index} className={Styles.comparisonRow}>
                ...
                <Box className={Styles.comparisonCell}>
