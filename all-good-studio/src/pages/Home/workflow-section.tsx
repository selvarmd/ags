...
const workflowSteps: WorkflowStep[] = [
  {
    ...
    description:
      "Short kickoff call. Goals, scope, timeline, and ‘definition of done’.",
  },
  {
    step: "02",
    image: Flow2,
    ...
    description:
      "We speed up research and first drafts with AI. You see options quickly.",
  },
  {
    step: "03",
    image: Flow3,
    ...
    description:
      "An experienced designer checks every deliverable. Clean, accessible build.",
  },
  {
    step: "04",
    image: Flow4,
    ...
    description:
      "Staging review, analytics, and rollback plan. 30 days of support after launch.",
  },
];
  ...
  return (
    ...
    >
      <AgsContainer>
        ...
        <Box className={`workflow-card-Wrapper ${Styles.workflowCards}`}>
          {workflowSteps.map((step, index) => (
            <Box key={index} className={Styles.workflowCard}>
              <TiltedCard
                ...
                overlayContent={
                  <Box className={Styles.workCardContent}>
