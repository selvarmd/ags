...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Get quick clarity on what’s hurting your site or app, plus fixes you can apply right away.",
    features: [
      "Review of 3 key pages",
      "Speed + usability check",
  ...
  },
  {
    ...
    description:
      "Update your look and build a toolkit you can reuse everywhere.",
    features: [
      "Logo refinements/new options",
      "Updated colors + fonts",
      "Core buttons + layouts",
      "Organized library file",
      "Easy style guide",
    ],
    price: "from $2,000",
  },
  {
    ...
    description:
      "Low-fidelity screens with high-conversion UX writing, ready to test.",
    features: [
      "Wireframes for up to 5 pages",
      ...
      <AgsContainer>
        <Box className={Styles.titleBlock}>
          ...
          <Box className={Styles.serviceTitleDescriptionWrapper}>
            <Typography
              variant="body1"
              className={Styles.serviceTitleDescription}
            >
              Fast where it helps. Careful where it counts. Fixed scopes. Clear
              pricing.
            </Typography>
          </Box>
        </Box>
